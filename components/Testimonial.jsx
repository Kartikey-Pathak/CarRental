...
function Testimonial() {
    ...
    return (
        ...
        <section className=" mt-14 w-full lg:w-[95%] flex items-center rounded-[3rem] text-center justify-center  bg-[#191919] flex-col">
            <h1 ref={txt5} className=" text-3xl md:text-5xl font-bogle font-semibold text-white m-10">Customer Reviews</h1>
