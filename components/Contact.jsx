...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen md:mt-10 mt-20 bg-[#191919] flex items-center justify-center px-6">
        <div className="w-full lg:w-[95%] bg-black rounded-2xl shadow-lg p-8 grid md:grid-cols-2 gap-10">
          ...
          >
            <div className="grid text-white md:grid-cols-2 gap-4">
              <InputField  className="text-white" label="First Name" placeholder="Enter Your Name" />
              <InputField className="text-white"  label="Last Name" placeholder="Enter Your Name" />
            </div>

            <div className="grid text-white md:grid-cols-2 gap-4">
              <InputField className="text-white"  label="Email" placeholder="Enter Your Email" type="email" />
              <InputField className="text-white"  label="Phone" placeholder="Enter Your Number" />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border-b text-white border-gray-300 focus:outline-none focus:border-white py-2 resize-none"
              />
            </div>
...
const InputField = ({ label, placeholder, type = "text" }) => (
  <div>
    ...
    <input
      ...
      className="w-full border-b text-white border-gray-300 focus:outline-none focus:border-gray-400 py-2"
    />
  </div>
);
...
const SocialIcon = ({ link, children }) => (
  <a
    ...
    className="w-10 h-10 flex items-center justify-center rounded-full border border-gray-300 hover:border-orange-500 hover:text-orange-500 transition"
  >
    {children}
  </a>
);
